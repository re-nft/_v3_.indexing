...
export const events = {
    RentalOrderStarted: new LogEvent<([orderHash: string, emittedExtraData: string, seaportOrderHash: string, items: Array<([itemType: number, settleTo: number, token: string, amount: bigint, identifier: bigint] & {itemType: number, settleTo: number, token: string, amount: bigint, identifier: bigint})>, hooks: Array<([target: string, itemIndex: bigint, extraData: string] & {target: string, itemIndex: bigint, extraData: string})>, lender: string, renter: string, rentalWallet: string, endTimestamp: bigint] & {orderHash: string, emittedExtraData: string, seaportOrderHash: string, items: Array<([itemType: number, settleTo: number, token: string, amount: bigint, identifier: bigint] & {itemType: number, settleTo: number, token: string, amount: bigint, identifier: bigint})>, hooks: Array<([target: string, itemIndex: bigint, extraData: string] & {target: string, itemIndex: bigint, extraData: string})>, lender: string, renter: string, rentalWallet: string, endTimestamp: bigint})>(
        abi, '0xa0be5c6bbc71c16a4a749259018082440c1b1a701d1aabfbb3faddb9e7575d8b'
    ),
