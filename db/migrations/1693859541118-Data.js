module.exports = class Data1693859541118 {
    name = 'Data1693859541118'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "rental_factory_event_rental_safe_deployment" ("id" character varying NOT NULL, "network" text NOT NULL, "block_number" integer NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" text NOT NULL, "contract" text NOT NULL, "event_name" text NOT NULL, "safe" text NOT NULL, "rental_manager" text NOT NULL, "guard" text NOT NULL, "owner" text NOT NULL, "nonce" numeric NOT NULL, CONSTRAINT "PK_11953556bcc549e2ab3ab797b95" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_0a9318b529df87dcffafa03275" ON "rental_factory_event_rental_safe_deployment" ("network") `)
        ...
        await db.query(`CREATE TABLE "rental_manager_event_rental_started" ("id" character varying NOT NULL, "network" text NOT NULL, "block_number" integer NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" text NOT NULL, "contract" text NOT NULL, "event_name" text NOT NULL, "seaport_order_hash" text NOT NULL, "renter_wallet" text NOT NULL, "lender" text NOT NULL, "collection" text NOT NULL, "token_id" numeric NOT NULL, "fulfiller" text NOT NULL, "rent_end_timestamp" numeric NOT NULL, CONSTRAINT "PK_93c08cec0e4ef56f487e60ca192" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_e7d23818ef694563444e1d9537" ON "rental_manager_event_rental_started" ("network") `)
        ...
        await db.query(`CREATE TABLE "rental_manager_event_rental_stopped" ("id" character varying NOT NULL, "network" text NOT NULL, "block_number" integer NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" text NOT NULL, "contract" text NOT NULL, "event_name" text NOT NULL, "seaport_order_hash" text NOT NULL, "renter_wallet" text NOT NULL, "lender" text NOT NULL, "collection" text NOT NULL, "token_id" numeric NOT NULL, "stopper" text NOT NULL, CONSTRAINT "PK_1c96a0fa06dd8c58980e1a15ebb" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_000f943e282b4be072acb0f20d" ON "rental_manager_event_rental_stopped" ("network") `)
        ...
        await db.query(`CREATE TABLE "rental_manager_function_rent_from_zone" ("id" character varying NOT NULL, "network" text NOT NULL, "block_number" integer NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" text NOT NULL, "contract" text NOT NULL, "function_name" text NOT NULL, "function_value" numeric, "function_success" boolean, "payload" jsonb NOT NULL, "seaport_order_hash" text NOT NULL, "seaport_zone_hash" text NOT NULL, "offer" jsonb NOT NULL, "consideration" jsonb NOT NULL, "seaport_fulfiller" text NOT NULL, "offerer" text NOT NULL, "signature" text NOT NULL, CONSTRAINT "PK_e2f9da4cb432797ffd6b78e849d" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_7adbd8865528f696b59e2b1cb3" ON "rental_manager_function_rent_from_zone" ("network") `)
        ...
        await db.query(`CREATE TABLE "rental_manager_function_set_zone" ("id" character varying NOT NULL, "network" text NOT NULL, "block_number" integer NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" text NOT NULL, "contract" text NOT NULL, "function_name" text NOT NULL, "function_value" numeric, "function_success" boolean, "new_zone" text NOT NULL, CONSTRAINT "PK_a457e38921e4d02bc787d3b4ed3" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_584a260cf351f50da9009ec7af" ON "rental_manager_function_set_zone" ("network") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_7adbd8865528f696b59e2b1cb3"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_584a260cf351f50da9009ec7af"`)
